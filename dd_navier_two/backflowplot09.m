function backflowplot09(qmethod,sol,start_data,contourn,spc,fig,fign)
...
db=bound(find(xy(bound,1)==max(xy(:,1))));
bound=setdiff(bound,db(2:end-1));
obs=start_data.obs;
...
set(gcf,'Position',[100,100,1200,1200]);%[100,100,1200,200]
[X,Y]=meshgrid(x,y);

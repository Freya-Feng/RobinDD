...
%% plot streamlines
cd /Users/fengyani/Desktop/ifiss3.6_final
system('/bin/cp ./domain_decomposition_Robin/dd_stokes_exact/myspecific_left_flow_rb.m ./diffusion/specific_bc.m');
spc=1;
qmethod=1;
% dd plot
%flowplot
myflowplot(qmethod,[u;p],start_data.By,start_data.Bx,start_data.A,start_data.xy,start_data.xyp,start_data.x,start_data.y,start_data.bound,spc,51);
% FEM plot
%flowplot
myflowplot(qmethod,xst,start_data.By,start_data.Bx,start_data.A,start_data.xy,start_data.xyp,start_data.x,start_data.y,start_data.bound,spc,61);
hold on
plot([0.5,0.5],[0,1],'--r')
